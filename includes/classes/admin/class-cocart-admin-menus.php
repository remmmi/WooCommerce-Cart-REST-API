	...
	class CoCart_Admin_Menus {
		...
		public function add_main_menu_page() {
			add_menu_page(
				...
				'data:image/svg+xml;base64,' . base64_encode( '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
' ), // php:ignore WordPress.PHP.DiscouragedPHPFunctions.obfuscation_base64_encode
				80
			);
