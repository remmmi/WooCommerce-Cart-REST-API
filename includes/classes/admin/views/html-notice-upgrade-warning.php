...
<div class="notice notice-info cocart-notice">
	<div class="cocart-notice-inner">
		...
		<div class="cocart-action">
			<?php printf( '<a href="%1$s" class="button button-primary cocart-button" target="_blank" rel="noopener noreferrer">%2$s</a>', esc_url( 'https://github.com/co-cart/co-cart/blob/development/NEXT_CHANGELOG.md' ), esc_html__( "What's Coming Next?", 'cart-rest-api-for-woocommerce' ) ); ?>
