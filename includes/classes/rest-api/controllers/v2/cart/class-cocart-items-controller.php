...
class_alias( 'CoCart_REST_Items_V2_Controller', 'CoCart_Items_V2_Controller' );
...
class CoCart_REST_Items_V2_Controller extends CoCart_REST_Cart_V2_Controller {
	...
	public function view_items() {
		try {
			...
			if ( empty( $cart_contents ) ) {
				$message = esc_html__( 'No items in the cart.', 'cocart-core' );
	...
	public function get_public_items_schema() {
		return array(
			...
			'properties' => array(
				'[a-z0-9]' => array(
					'description' => __( 'The item container identified with the unique ID of the item.', 'cocart-core' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'properties'  => array(
						'item_key'       => array(
						...
						'quantity'       => array(
							'description' => __( 'The quantity of the item and minimum and maximum purchase capability.', 'cocart-core' ),
							'type'        => 'object',
							'context'     => array( 'view' ),
							'properties'  => array(
								'value'        => array(
						...
						'totals'         => array(
							...
							'properties'  => array(
								'subtotal'     => array(
									'description' => __( 'The subtotal of the item in cart.', 'cocart-core' ),
									'type'        => 'float',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'subtotal_tax' => array(
									'description' => __( 'The subtotal tax of the item in cart.', 'cocart-core' ),
									'type'        => 'float',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'total'        => array(
									'description' => __( 'The total of the item in cart.', 'cocart-core' ),
									'type'        => 'float',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'total_tax'    => array(
									'description' => __( 'The total tax of the item in cart.', 'cocart-core' ),
									'type'        => 'float',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
						...
						'slug'           => array(
							'description' => __( 'The product slug of the item.', 'cocart-core' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'meta'           => array(
							'description' => __( 'The meta data of the item.', 'cocart-core' ),
							'type'        => 'object',
							'context'     => array( 'view' ),
							'properties'  => array(
								'product_type' => array(
									'description' => __( 'The product type of the item in cart.', 'cocart-core' ),
									'type'        => 'string',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'sku'          => array(
									'description' => __( 'The SKU of the item in cart.', 'cocart-core' ),
									'type'        => 'string',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'dimensions'   => array(
									'description' => __( 'The dimensions of the item in cart.', 'cocart-core' ),
									'type'        => 'object',
									'context'     => array( 'view' ),
									'properties'  => array(
										'length' => array(
											'description' => __( 'The length of the item in cart.', 'cocart-core' ),
											'type'        => 'string',
											'context'     => array( 'view' ),
											'readonly'    => true,
										),
										'width'  => array(
											'description' => __( 'The width of the item in cart.', 'cocart-core' ),
											'type'        => 'string',
											'context'     => array( 'view' ),
											'readonly'    => true,
										),
										'height' => array(
											'description' => __( 'The height of the item in cart.', 'cocart-core' ),
											'type'        => 'string',
											'context'     => array( 'view' ),
											'readonly'    => true,
										),
										'unit'   => array(
											'description' => __( 'The unit measurement of the item in cart.', 'cocart-core' ),
											'type'        => 'string',
											'context'     => array( 'view' ),
											'readonly'    => true,
										),
								...
								'weight'       => array(
									'description' => __( 'The weight of the item in cart.', 'cocart-core' ),
									'type'        => 'string',
									'context'     => array( 'view' ),
									'readonly'    => true,
								),
								'variation'    => array(
									'description' => __( 'The variation attributes of the item in cart (if item is a variation of a variable product).', 'cocart-core' ),
									'type'        => 'object',
									'context'     => array( 'view' ),
									'properties'  => array(),
								),
						...
						'cart_item_data' => array(
							'description' => __( 'Custom item data applied to the item in cart (if any).', 'cocart-core' ),
							'type'        => 'object',
							'context'     => array( 'view' ),
							'properties'  => array(),
						),
						'featured_image' => array(
							'description' => __( 'The featured image of the item.', 'cocart-core' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
